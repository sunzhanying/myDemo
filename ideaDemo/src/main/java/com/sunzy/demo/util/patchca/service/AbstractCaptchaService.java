 ...
 */
package com.sunzy.demo.util.patchca.service;


import com.sunzy.demo.util.patchca.background.BackgroundFactory;
import com.sunzy.demo.util.patchca.color.ColorFactory;
import com.sunzy.demo.util.patchca.filter.FilterFactory;
import com.sunzy.demo.util.patchca.font.FontFactory;
import com.sunzy.demo.util.patchca.text.renderer.TextRenderer;
import com.sunzy.demo.util.patchca.word.WordFactory;
