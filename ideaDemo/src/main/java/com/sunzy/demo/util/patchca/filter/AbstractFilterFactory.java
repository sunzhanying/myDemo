 ...
 */
package com.sunzy.demo.util.patchca.filter;
...
public abstract class AbstractFilterFactory implements FilterFactory {
	...
	public BufferedImage applyFilters(BufferedImage source) {
		...
		BufferedImage source1 = new BufferedImage(source.getWidth(), source.getHeight(),
				source.getType());
		source1.getGraphics().drawImage(dest, x, y, null);
		return source1;
	}
